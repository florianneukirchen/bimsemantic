...
class IdsEditDialog(QDialog):
    ...
    def show_facet_layout(self, facet_type, facet=None):
        ...
        if facet_type == "Entity":
            ...
            self.label1.setText(self.tr("Name"))
            self.label2.setText(self.tr("Predefined Type"))
            self.label3.hide()
            self.label4.hide()
            self.label5.hide()
            ...
            self.required_parameters([1])
            self.label1.setText(self.tr("Name"))
            self.label2.setText(self.tr("Value"))
            self.label3.hide()
            self.label4.hide()
            self.label5.hide()
            ...
            self.label1.setText(self.tr("Property Set"))
            self.label2.setText(self.tr("Property Name"))
            self.label3.setText(self.tr("Value"))
            self.label4.setText(self.tr("Data Type"))
            ...
            self.required_parameters([1])
            self.label1.setText(self.tr("Entity"))
            self.label2.setText(self.tr("Predefined Type"))
            self.label3.setText(self.tr("Relation"))
            self.label3.show()
            self.label4.hide()
            self.label5.hide()
            self.cardinality_label.show()
            ...
            self.label1.setText(self.tr("Value"))
            ...
            self.required_parameters([1])
            self.label1.setText(self.tr("System"))
            self.label2.setText(self.tr("Value"))
